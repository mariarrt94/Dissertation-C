...
##### Load reading data code #####

source('1_data_reading.R')
...
time_02 <- iiia_ata_02 %>% 
  mutate(folio_aux = str_sub(folio, 1L, -3L),
         ...
         pid_link = paste(folio_2, "00", ls, sep = ""),
         year = 2002) %>% 
  # ata01f = hours Take care of elderly or sick people and/or children
  select(year, folio, pid_link, ata01d, ata01e, ata01f, ata01g, ata02d, 
         ata02e, ata02f, ata02g)
...
rm(list=setdiff(ls(), c("basic_folio", "bio_base", "weight_s", "weight_sl", "basic_ind", "ed_base", "health_base",
                        ...
                        "edna_base", "weight_5", "weight_5l", "time_base")))

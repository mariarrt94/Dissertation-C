...
# This code runs the regressions to determine the effect of bargaining power in children outcomes
...
##### Reported on disseration: Test separated #####

test_mod1_s <- plm(test_score_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "pooling")

test_mod2_s <- plm(test_score_z ~ PC1ch_mom + PC1money_mom + ls02_2  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
test_mod3_s <- plm(test_score_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "within", effect = "individual")
pFtest(test_mod3_s, test_mod1_s)# F test for time effects: OLS vs pooled reject OLS in favour of individual effects F = 1.2097, df1 = 3015, df2 = 976, p-value = 0.0001682
test_mod4_s <- plm(test_score_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "within", effect = "twoways")
pFtest(test_mod4_s, test_mod1_s)# F test for time effects: OLS vs pooled  0.0001567 reject OLS 1.2094, df1 = 3017, df2 = 974, p-value = 0.0001732

test_mod5_s <- plm(test_score_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
hfa_mod1_s <- plm(height_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad + log_income_crea_pc + children,
                  data = pdata_child_t, model = "pooling")

hfa_mod2_s <- plm(height_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad + log_income_crea_pc + children,
                  data = pdata_child_t, model = "within", effect = "time")
pFtest(hfa_mod2_s, hfa_mod1_s)# F test for time effects: OLS vs pooled .4046 I cannot reject 0.8947, df1 = 2, df2 = 4910, p-value = 0.4088

hfa_mod3_s <- plm(height_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad + log_income_crea_pc + children,
                  data = pdata_child_t, model = "within", effect = "individual")
pFtest(hfa_mod3_s, hfa_mod1_s)# F test for time effects: reject OLS 1.3594, df1 = 3469, df2 = 1443, p-value = 0.000000000006439

hfa_mod4_s <- plm(height_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad + log_income_crea_pc + children,
                  data = pdata_child_t, model = "within", effect = "twoways")
pFtest(hfa_mod4_s, hfa_mod1_s)# F test for time effects: reject OLS = 1.3594, df1 = 3471, df2 = 1441, p-value = 0.000000000006536

hfa_mod5_s <- plm(height_z ~ PC1ch_mom + PC1money_mom + ls02_2 + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad + log_income_crea_pc + children,
                  data = pdata_child_t, model = "random")
phtest(hfa_mod4_s, hfa_mod5_s) #Hausman test  under H0 random is preferred 0.00376 reject preferred is fixed

# generate clustered standard errors in a list v

rob_se_h_s <- list(sqrt(diag(vcovHC(hfa_mod1_s, type = "HC1"))),
                   sqrt(diag(vcovHC(hfa_mod2_s, type = "HC1"))),
...
stargazer(hfa_mod1_s, hfa_mod2_s, hfa_mod3_s, hfa_mod4_s, 
          ...
          no.space = TRUE, align = TRUE,
          se = rob_se_h_s, model.numbers = FALSE,  column.labels = c("(1)", "(2)", "(3)", "(4)"), 
          add.lines = list(c('Individual Effects', 'No', 'No', 'Yes', 'Yes'),
                           c('Time Effects', 'No', 'Yes', 'No', 'Yes'),
                           c('F test fixed effects', '', '0.895', ' 1.359', '1.359')),
          column.sep.width = "5pt", # Well... you can tweak this,
          omit.stat = c("adj.rsq"),
...
test_mod1_g <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                 + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                 data = pdata_child_t, model = "pooling", subset = sex == 0)

test_mod2_g <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                 + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
test_mod3_g <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                 + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
test_mod4_g <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                 + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
test_mod1_b <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "pooling", subset = sex == 1)

test_mod2_b <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
test_mod3_b <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
test_mod4_b <- plm(test_score_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + test_score_mom 
                   + test_score_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
...
rob_se_bg <- list(sqrt(diag(vcovHC(test_mod3_g, type = "HC1"))),
                 sqrt(diag(vcovHC(test_mod4_g, type = "HC1"))),
                 sqrt(diag(vcovHC(test_mod3_b, type = "HC1"))),
                 sqrt(diag(vcovHC(test_mod4_b, type = "HC1"))))
...
stargazer(test_mod3_g, test_mod4_g, test_mod3_b, test_mod4_b, 
          ...
          covariate.labels=c("Bargaining Index C", "Bargaining Index F", "School attendance", 
                             ...
                             "Household income pc", "# Children"),
          no.space = TRUE, align = TRUE,
          se = rob_se_bg, model.numbers = FALSE,  column.labels = c("Girls (3)", "Girls (4)", "Boys (3)", "Boys (4)"), 
...
hfa_mod1_g <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                   + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "pooling", subset = sex == 0)

hfa_mod2_g <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                   + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "within", effect = "time", subset = sex == 0)
...
hfa_mod3_g <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                   + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "within", effect = "individual", subset = sex == 0)
pFtest(hfa_mod3_g, hfa_mod1_g)# F = 1.4949, df1 = 1954, df2 = 467, p-value = 0.00000006627 reject FE preferred

hfa_mod4_g <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                   + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                   data = pdata_child_t, model = "within", effect = "twoways", subset = sex == 0)
pFtest(hfa_mod4_g, hfa_mod1_g)# F = 1.5104, df1 = 1956, df2 = 465, p-value = 0.00000003411, FE preferred

hfa_mod1_b <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                  data = pdata_child_t, model = "pooling", subset = sex == 1)

hfa_mod2_b <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                  data = pdata_child_t, model = "within", effect = "time", subset = sex == 1)
pFtest(hfa_mod2_b, hfa_mod1_b)# F = 1.7384, df1 = 2, df2 = 2477, p-value = 0.176, I cannot reject OLS

hfa_mod3_b <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                  data = pdata_child_t, model = "within", effect = "individual", subset = sex == 1)
pFtest(hfa_mod3_b, hfa_mod1_b)# F = 1.3153, df1 = 2005, df2 = 474, p-value = 0.0001206 reject FE preferred

hfa_mod4_b <- plm(height_z ~ PC1ch_mom + PC1money_mom  + school_att + edn09 + worked_12_mom + HH_mom + height_mom 
                  + height_dad  + edu_mom + edu_dad +  log_income_crea_pc + children,
                  data = pdata_child_t, model = "within", effect = "twoways", subset = sex == 1)
pFtest(hfa_mod4_b, hfa_mod1_b)#F = 1.3321, df1 = 2007, df2 = 472, p-value = 0.00006398, FE preferred

rob_se_bg_h <- list(sqrt(diag(vcovHC(hfa_mod3_g, type = "HC1"))),
                   sqrt(diag(vcovHC(hfa_mod4_g, type = "HC1"))),
                   sqrt(diag(vcovHC(hfa_mod3_b, type = "HC1"))),
                   sqrt(diag(vcovHC(hfa_mod4_b, type = "HC1"))))
